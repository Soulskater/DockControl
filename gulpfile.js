...
var paths = {
    scripts: ['src/js/dockDirective.js', 'src/js/**/*.js', '!src/js/lib/**/*.js'],
    css: 'src/css/dockControl.css',
...
gulp.task('scripts-min', function () {
    return gulp.src(paths.scripts)
        ...
        .pipe(concat('dockControl.min.js'))
        .pipe(uglify())
...
gulp.task('css-min', function () {
    return gulp.src(paths.css)
        .pipe(minifyCss())
        .pipe(concat('dockControl.min.css'))
